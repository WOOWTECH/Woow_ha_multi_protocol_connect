"""Service layer for Woow DMX Setup Guide.
...
def register_services(hass: HomeAssistant) -> None:
    """Register the DMX service layer (idempotent)."""
    ...
    _LOGGER.info("Woow DMX service layer registered")


def unregister_services(hass: HomeAssistant) -> None:
    """Remove the DMX service layer."""
    for service in (
