"""Woow DMX Setup Guide - Sidebar panel with built-in YAML editor."""
...
async def async_setup(hass: HomeAssistant, config: dict) -> bool:
    """Set up the Woow DMX component from yaml (unused, config_flow only)."""
    return True


async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    """Set up Woow DMX Setup Guide from a config entry."""
