"""Service layer for Woow KNX Setup Guide.
...
def register_services(hass: HomeAssistant) -> None:
    """Register the KNX service layer (idempotent)."""
    ...
    _LOGGER.info("Woow KNX service layer registered")


def unregister_services(hass: HomeAssistant) -> None:
    """Remove the KNX service layer."""
    for service in (
