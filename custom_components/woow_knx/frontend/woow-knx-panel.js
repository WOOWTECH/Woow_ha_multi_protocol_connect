 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */Symbol.metadata??=Symbol("metadata"),h.litPropertyMetadata??=new WeakMap;let y=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=b){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){const s=Symbol(),r=this.getPropertyDescriptor(t,s,e);void 0!==r&&n(this.prototype,t,r)}}static getPropertyDescriptor(t,e,s){const{get:r,set:o}=l(this.prototype,t)??{get(){return this[e]},set(t){this[e]=t}};return{get:r,set(e){const i=r?.call(this);o?.call(this,e),this.requestUpdate(t,i,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??b}static _$Ei(){if(this.hasOwnProperty(f("elementProperties")))return;const t=p(this);t.finalize(),void 0!==t.l&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(f("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(f("properties"))){const t=this.properties,e=[...d(t),...c(t)];for(const s of e)this.createProperty(s,t[s])}const t=this[Symbol.metadata];if(null!==t){const e=litPropertyMetadata.get(t);if(void 0!==e)for(const[t,s]of e)this.elementProperties.set(t,s)}this._$Eh=new Map;for(const[t,e]of this.elementProperties){const s=this._$Eu(t,e);void 0!==s&&this._$Eh.set(s,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const s=new Set(t.flat(1/0).reverse());for(const t of s)e.unshift(i(t))}else void 0!==t&&e.push(i(t));return e}static _$Eu(t,e){const s=e.attribute;return!1===s?void 0:"string"==typeof s?s:"string"==typeof t?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),void 0!==this.renderRoot&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const s of e.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const s=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return((s,r)=>{if(e)s.adoptedStyleSheets=r.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const e of r){const r=document.createElement("style"),o=t.litNonce;void 0!==o&&r.setAttribute("nonce",o),r.textContent=e.cssText,s.appendChild(r)}})(s,this.constructor.elementStyles),s}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,s){this._$AK(t,s)}_$ET(t,e){const s=this.constructor.elementProperties.get(t),r=this.constructor._$Eu(t,s);if(void 0!==r&&!0===s.reflect){const o=(void 0!==s.converter?.toAttribute?s.converter:m).toAttribute(e,s.type);this._$Em=t,null==o?this.removeAttribute(r):this.setAttribute(r,o),this._$Em=null}}_$AK(t,e){const s=this.constructor,r=s._$Eh.get(t);if(void 0!==r&&this._$Em!==r){const t=s.getPropertyOptions(r),o="function"==typeof t.converter?{fromAttribute:t.converter}:void 0!==t.converter?.fromAttribute?t.converter:m;this._$Em=r;const i=o.fromAttribute(e,t.type);this[r]=i??this._$Ej?.get(r)??i,this._$Em=null}}requestUpdate(t,e,s,r=!1,o){if(void 0!==t){const i=this.constructor;if(!1===r&&(o=this[t]),s??=i.getPropertyOptions(t),!((s.hasChanged??v)(o,e)||s.useDefault&&s.reflect&&o===this._$Ej?.get(t)&&!this.hasAttribute(i._$Eu(t,s))))return;this.C(t,e,s)}!1===this.isUpdatePending&&(this._$ES=this._$EP())}C(t,e,{useDefault:s,reflect:r,wrapped:o},i){s&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,i??e??this[t]),!0!==o||void 0!==i)||(this._$AL.has(t)||(this.hasUpdated||s||(e=void 0),this._$AL.set(t,e)),!0===r&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[t,e]of this._$Ep)this[t]=e;this._$Ep=void 0}const t=this.constructor.elementProperties;if(t.size>0)for(const[e,s]of t){const{wrapped:t}=s,r=this[e];!0!==t||this._$AL.has(e)||void 0===r||this.C(e,void 0,s,r)}}let t=!1;const e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(t=>t.hostUpdate?.()),this.update(e)):this._$EM()}catch(e){throw t=!1,this._$EM(),e}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(t){}firstUpdated(t){}};y.elementStyles=[],y.shadowRootOptions={mode:"open"},y[f("elementProperties")]=new Map,y[f("finalized")]=new Map,g?.({ReactiveElement:y}),(h.reactiveElementVersions??=[]).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const x=globalThis,w=t=>t,$=x.trustedTypes,A=$?$.createPolicy("lit-html",{createHTML:t=>t}):void 0,S="$lit$",C=`lit$${Math.random().toFixed(9).slice(2)}$`,k="?"+C,E=`<${k}>`,N=document,F=()=>N.createComment(""),z=t=>null===t||"object"!=typeof t&&"function"!=typeof t,H=Array.isArray,K="[ \t\n\f\r]",I=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,M=/-->/g,L=/>/g,P=RegExp(`>|${K}(?:([^\\s"'>=/]+)(${K}*=${K}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),T=/'/g,R=/"/g,U=/^(?:script|style|textarea|title)$/i,D=(t=>(e,...s)=>({_$litType$:t,strings:e,values:s}))(1),X=Symbol.for("lit-noChange"),O=Symbol.for("lit-nothing"),Y=new WeakMap,B=N.createTreeWalker(N,129);function W(t,e){if(!H(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==A?A.createHTML(e):e}const j=(t,e)=>{const s=t.length-1,r=[];let o,i=2===e?"<svg>":3===e?"<math>":"",a=I;for(let e=0;e<s;e++){const s=t[e];let n,l,d=-1,c=0;for(;c<s.length&&(a.lastIndex=c,l=a.exec(s),null!==l);)c=a.lastIndex,a===I?"!--"===l[1]?a=M:void 0!==l[1]?a=L:void 0!==l[2]?(U.test(l[2])&&(o=RegExp("</"+l[2],"g")),a=P):void 0!==l[3]&&(a=P):a===P?">"===l[0]?(a=o??I,d=-1):void 0===l[1]?d=-2:(d=a.lastIndex-l[2].length,n=l[1],a=void 0===l[3]?P:'"'===l[3]?R:T):a===R||a===T?a=P:a===M||a===L?a=I:(a=P,o=void 0);const p=a===P&&t[e+1].startsWith("/>")?" ":"";i+=a===I?s+E:d>=0?(r.push(n),s.slice(0,d)+S+s.slice(d)+C+p):s+C+(-2===d?e:p)}return[W(t,i+(t[s]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),r]};class G{constructor({strings:t,_$litType$:e},s){let r;this.parts=[];let o=0,i=0;const a=t.length-1,n=this.parts,[l,d]=j(t,e);if(this.el=G.createElement(l,s),B.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(r=B.nextNode())&&n.length<a;){if(1===r.nodeType){if(r.hasAttributes())for(const t of r.getAttributeNames())if(t.endsWith(S)){const e=d[i++],s=r.getAttribute(t).split(C),a=/([.?@])?(.*)/.exec(e);n.push({type:1,index:o,name:a[2],strings:s,ctor:"."===a[1]?Q:"?"===a[1]?tt:"@"===a[1]?et:Z}),r.removeAttribute(t)}else t.startsWith(C)&&(n.push({type:6,index:o}),r.removeAttribute(t));if(U.test(r.tagName)){const t=r.textContent.split(C),e=t.length-1;if(e>0){r.textContent=$?$.emptyScript:"";for(let s=0;s<e;s++)r.append(t[s],F()),B.nextNode(),n.push({type:2,index:++o});r.append(t[e],F())}}}else if(8===r.nodeType)if(r.data===k)n.push({type:2,index:o});else{let t=-1;for(;-1!==(t=r.data.indexOf(C,t+1));)n.push({type:7,index:o}),t+=C.length-1}o++}}static createElement(t,e){const s=N.createElement("template");return s.innerHTML=t,s}}function q(t,e,s=t,r){if(e===X)return e;let o=void 0!==r?s._$Co?.[r]:s._$Cl;const i=z(e)?void 0:e._$litDirective$;return o?.constructor!==i&&(o?._$AO?.(!1),void 0===i?o=void 0:(o=new i(t),o._$AT(t,s,r)),void 0!==r?(s._$Co??=[])[r]=o:s._$Cl=o),void 0!==o&&(e=q(t,o._$AS(t,e.values),o,r)),e}class V{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:s}=this._$AD,r=(t?.creationScope??N).importNode(e,!0);B.currentNode=r;let o=B.nextNode(),i=0,a=0,n=s[0];for(;void 0!==n;){if(i===n.index){let e;2===n.type?e=new J(o,o.nextSibling,this,t):1===n.type?e=new n.ctor(o,n.name,n.strings,this,t):6===n.type&&(e=new st(o,this,t)),this._$AV.push(e),n=s[++a]}i!==n?.index&&(o=B.nextNode(),i++)}return B.currentNode=N,r}p(t){let e=0;for(const s of this._$AV)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class J{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,r){this.type=2,this._$AH=O,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=q(this,t,e),z(t)?t===O||null==t||""===t?(this._$AH!==O&&this._$AR(),this._$AH=O):t!==this._$AH&&t!==X&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>H(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==O&&z(this._$AH)?this._$AA.nextSibling.data=t:this.T(N.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:s}=t,r="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=G.createElement(W(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===r)this._$AH.p(e);else{const t=new V(r,this),s=t.u(this.options);t.p(e),this.T(s),this._$AH=t}}_$AC(t){let e=Y.get(t.strings);return void 0===e&&Y.set(t.strings,e=new G(t)),e}k(t){H(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,r=0;for(const o of t)r===e.length?e.push(s=new J(this.O(F()),this.O(F()),this,this.options)):s=e[r],s._$AI(o),r++;r<e.length&&(this._$AR(s&&s._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=w(t).nextSibling;w(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class Z{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,r,o){this.type=1,this._$AH=O,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=O}_$AI(t,e=this,s,r){const o=this.strings;let i=!1;if(void 0===o)t=q(this,t,e,0),i=!z(t)||t!==this._$AH&&t!==X,i&&(this._$AH=t);else{const r=t;let a,n;for(t=o[0],a=0;a<o.length-1;a++)n=q(this,r[s+a],e,a),n===X&&(n=this._$AH[a]),i||=!z(n)||n!==this._$AH[a],n===O?t=O:t!==O&&(t+=(n??"")+o[a+1]),this._$AH[a]=n}i&&!r&&this.j(t)}j(t){t===O?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Q extends Z{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===O?void 0:t}}class tt extends Z{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==O)}}class et extends Z{constructor(t,e,s,r,o){super(t,e,s,r,o),this.type=5}_$AI(t,e=this){if((t=q(this,t,e,0)??O)===X)return;const s=this._$AH,r=t===O&&s!==O||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==O&&(s===O||r);r&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class st{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){q(this,t)}}const rt=x.litHtmlPolyfillSupport;rt?.(G,J),(x.litHtmlVersions??=[]).push("3.3.2");const ot=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let it=class extends y{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,s)=>{const r=s?.renderBefore??e;let o=r._$litPart$;if(void 0===o){const t=s?.renderBefore??null;r._$litPart$=o=new J(e.insertBefore(F(),t),t,void 0,s??{})}return o._$AI(t),o})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return X}};it._$litElement$=!0,it.finalized=!0,ot.litElementHydrateSupport?.({LitElement:it});const at=ot.litElementPolyfillSupport;at?.({LitElement:it}),(ot.litElementVersions??=[]).push("4.2.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class dt extends lt{constructor(t){if(super(t),this.it=O,t.type!==nt)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===O||null==t)return this._t=void 0,this.it=t;if(t===X)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}dt.directiveName="unsafeHTML",dt.resultType=1;const ct=(t=>(...e)=>({_$litDirective$:t,values:e}))(dt),pt=((t,...e)=>{const r=1===t.length?t[0]:e.reduce((e,s,r)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+t[r+1],t[0]);return new o(r,t,s)})`
  /* ============================================
...
`;class ht extends it{static get properties(){return{hass:{type:Object},panel:{type:Object},narrow:{type:Boolean},route:{type:Object},_files:{type:Array,state:!0},_currentFile:{type:String,state:!0},_editorContent:{type:String,state:!0},_editorDirty:{type:Boolean,state:!0},_fontSize:{type:Number,state:!0},_wsConnected:{type:Boolean,state:!0},_restartConfirmed:{type:Boolean,state:!0},_restartStatus:{type:String,state:!0},_restartStatusColor:{type:String,state:!0},_editorStatus:{type:String,state:!0},_editorStatusColor:{type:String,state:!0}}}static get styles(){return pt}constructor(){super(),this._files=[],this._currentFile="",this._editorContent="",this._editorDirty=!1,this._fontSize=14,this._wsConnected=!1,this._restartConfirmed=!1,this._restartStatus="",this._restartStatusColor="",this._editorStatus="",this._editorStatusColor="",this._originalContent="",this._hassReady=!1;const t={en:{editor_title:"✏️ YAML Configuration Editor",editor_select_placeholder:"-- Select File --",editor_refresh:"🔄 Refresh",editor_refresh_title:"Refresh file list",editor_font_smaller:"Decrease font size",editor_font_larger:"Increase font size",editor_ready:"Ready",editor_new_file:"+ New File",editor_save:"💾 Save",ws_connected:"● Connected",ws_disconnected:"● Disconnected",ws_not_connected:"WebSocket not connected",loading_files:"Loading file list...",found_files:"Found {0} YAML files",load_failed:"Failed to load file list: {0}",loading_file:"Loading {0}...",loaded_file:"Loaded: {0}",file_load_failed:"Load failed: {0}",select_or_new:"Please select or create a file first",confirm_save:"Are you sure you want to save {0}?",saving_file:"Saving {0}...",saved_file:"✓ Saved: {0}",save_failed:"Save failed: {0}",new_file_status:"New file: {0} (not saved yet)",unsaved_switch:"Current changes are not saved. Switch file anyway?",cache_restored:"Restored unsaved edits",cache_restored_file:"Restored unsaved edits: {0}",restart_title:"🔄 Restart Home Assistant",restart_warning_title:"⚠️ Important Warning",restart_warning_desc:"Restarting Home Assistant will <strong>temporarily interrupt all automations, device connections, and services</strong>. Please confirm the following before proceeding:",restart_li1:"All YAML configurations have been saved correctly with proper formatting",restart_li2:"No critical automations are currently running",restart_li3:"Household members have been notified of temporary system unavailability",restart_li4:"It is recommended to restart during off-peak hours",restart_tip_title:"💡 Tip",restart_confirm_label:"I confirm settings are saved and understand restart will temporarily interrupt services",restart_btn:"🔄 Restart Home Assistant",sending_restart:"Sending restart command...",restart_sent:"Restart command sent! Home Assistant is restarting, please wait 1-3 minutes...",restart_failed:"Unable to send restart command. Please go to Settings → System → Restart to restart manually. ({0})",request_timeout:"Request timeout"},"zh-Hant":{editor_title:"✏️ YAML 設定檔編輯器",editor_select_placeholder:"-- 選擇檔案 --",editor_refresh:"🔄 重新整理",editor_refresh_title:"重新整理檔案清單",editor_font_smaller:"縮小字體",editor_font_larger:"放大字體",editor_ready:"準備就緒",editor_new_file:"+ 新增檔案",editor_save:"💾 儲存",ws_connected:"● 已連線",ws_disconnected:"● 未連線",ws_not_connected:"WebSocket 未連線",loading_files:"正在載入檔案清單...",found_files:"找到 {0} 個 YAML 檔案",load_failed:"載入檔案清單失敗：{0}",loading_file:"正在載入 {0}...",loaded_file:"已載入：{0}",file_load_failed:"載入失敗：{0}",select_or_new:"請先選擇或新增檔案",confirm_save:"確定要儲存 {0} 嗎？",saving_file:"正在儲存 {0}...",saved_file:"✓ 已儲存：{0}",save_failed:"儲存失敗：{0}",new_file_status:"新檔案：{0}（尚未儲存）",unsaved_switch:"目前的變更尚未儲存，確定要切換檔案嗎？",cache_restored:"已恢復未儲存的編輯內容",cache_restored_file:"已恢復未儲存的編輯內容：{0}",restart_title:"🔄 重新啟動 Home Assistant",restart_warning_title:"⚠️ 重要警告",restart_warning_desc:"重新啟動 Home Assistant 將會<strong>暫時中斷所有自動化、裝置連線與服務</strong>。請確認以下事項後再執行：",restart_li1:"所有 YAML 設定已正確儲存，且格式無誤",restart_li2:"目前沒有關鍵的自動化正在執行中",restart_li3:"已通知家中成員系統將短暫無法使用",restart_li4:"建議在非尖峰時段執行重啟操作",restart_tip_title:"💡 提示",restart_confirm_label:"我確認已儲存設定，並了解重啟將暫時中斷服務",restart_btn:"🔄 重新啟動 Home Assistant",sending_restart:"正在發送重啟指令...",restart_sent:"重啟指令已送出！Home Assistant 正在重新啟動中，請稍候約 1-3 分鐘...",restart_failed:"無法發送重啟指令。請至 設定 → 系統 → 重新啟動 手動執行。({0})",request_timeout:"請求逾時"}},e=this.constructor.protocolTranslations;this._translations={en:{...t.en,...e.en},"zh-Hant":{...t["zh-Hant"],...e["zh-Hant"]}},this._handleKeydown=this._onGlobalKeydown.bind(this),this._handleBeforeUnload=this._onBeforeUnload.bind(this)}get _cfg(){return this.constructor.protocolConfig}get _language(){const t=(this.hass?.language||"en").toLowerCase();return"zh-hant"===t||"zh-tw"===t||"zh-hk"===t||t.startsWith("zh")?"zh-Hant":"en"}_t(t,...e){let s=(this._translations[this._language]||this._translations.en)[t]||this._translations.en[t]||t;return e.forEach((t,e)=>{s=s.replace(`{${e}}`,t)}),s}connectedCallback(){super.connectedCallback(),this._restoreFontSize(),this._restoreCache(),window.addEventListener("keydown",this._handleKeydown),window.addEventListener("beforeunload",this._handleBeforeUnload)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._handleKeydown),window.removeEventListener("beforeunload",this._handleBeforeUnload)}updated(t){super.updated(t),t.has("hass")&&this.hass&&!this._hassReady&&(this._hassReady=!0,this._wsConnected=!0,this._editorStatus=this._t("editor_ready"),this._refreshFileList()),t.has("hass")&&this.hass&&(this._wsConnected=!1!==this.hass.connected)}async _callWS(t){if(!this.hass)throw new Error(this._t("ws_not_connected"));return this.hass.callWS(t)}async _refreshFileList(){try{this._editorStatus=this._t("loading_files"),this._editorStatusColor="";const t=await this._callWS({type:this._cfg.wsType,action:"list",ext:"yaml",depth:10});this._files=t.files||[],this._editorStatus=this._t("found_files",this._files.length)}catch(t){this._editorStatus=this._t("load_failed",t.message||t)}}async _loadFile(t){if(!t)return this._currentFile="",this._editorContent="",this._originalContent="",this._editorDirty=!1,this._editorStatus=this._t("editor_ready"),void(this._editorStatusColor="");if(!this._editorDirty||!this._currentFile||confirm(this._t("unsaved_switch")))try{this._editorStatus=this._t("loading_file",t),this._editorStatusColor="";const e=await this._callWS({type:this._cfg.wsType,action:"load",path:t});this._editorContent=e.content,this._originalContent=e.content,this._currentFile=e.path||t,this._editorDirty=!1,this._editorStatus=this._t("loaded_file",this._currentFile),this._cacheState()}catch(t){this._editorStatus=this._t("file_load_failed",t.message||t),this._editorStatusColor="var(--status-danger)"}}async _saveFile(){if(this._currentFile){if(confirm(this._t("confirm_save",this._currentFile))){this._editorStatus=this._t("saving_file",this._currentFile),this._editorStatusColor="";try{await this._callWS({type:this._cfg.wsType,action:"save",path:this._currentFile,content:this._editorContent}),this._originalContent=this._editorContent,this._editorDirty=!1,this._editorStatusColor="var(--status-success)",this._editorStatus=this._t("saved_file",this._currentFile),this._cacheState(),setTimeout(()=>{this._editorStatusColor=""},4e3)}catch(t){this._editorStatusColor="var(--status-danger)",this._editorStatus=this._t("save_failed",t.message||t),setTimeout(()=>{this._editorStatusColor=""},5e3)}}}else this._editorStatus=this._t("select_or_new")}_newFile(){const t=prompt(this._t("new_file_prompt"),this._cfg.defaultNewFile);if(!t)return;let e=t.replace(/\.\./g,"").trim();e.endsWith(".yaml")||e.endsWith(".yml")||(e+=".yaml"),this._files.includes(e)||(this._files=[...this._files,e]),this._currentFile=e,this._editorContent="",this._originalContent="",this._editorDirty=!0,this._editorStatus=this._t("new_file_status",e),this._editorStatusColor=""}_changeFontSize(t){this._fontSize=Math.max(10,Math.min(24,this._fontSize+t));try{localStorage.setItem(`${this._cfg.localStoragePrefix}_fontsize`,this._fontSize)}catch(t){}}_restoreFontSize(){try{const t=localStorage.getItem(`${this._cfg.localStoragePrefix}_fontsize`);t&&(this._fontSize=parseInt(t,10)||14)}catch(t){}}_cacheState(){try{localStorage.setItem(`${this._cfg.localStoragePrefix}_cache`,JSON.stringify({file:this._currentFile,content:this._editorContent,dirty:this._editorDirty,ts:Date.now()}))}catch(t){}}_restoreCache(){try{const t=localStorage.getItem(`${this._cfg.localStoragePrefix}_cache`);if(!t)return;const e=JSON.parse(t);e.dirty&&e.content&&Date.now()-e.ts<36e5&&(this._editorContent=e.content,this._currentFile=e.file||"",this._editorDirty=!0,this._editorStatus=e.file?this._t("cache_restored_file",e.file):this._t("cache_restored"))}catch(t){}}_onGlobalKeydown(t){(t.ctrlKey||t.metaKey)&&"s"===t.key&&(t.preventDefault(),this._currentFile&&this._saveFile())}_onBeforeUnload(t){this._editorDirty&&(t.preventDefault(),t.returnValue="")}_onEditorInput(t){this._editorContent=t.target.value,this._editorDirty=this._editorContent!==this._originalContent,this._cacheState()}_onEditorKeydown(t){if("Tab"===t.key){t.preventDefault();const e=t.target,s=e.selectionStart,r=e.selectionEnd,o=e.value;e.value=o.substring(0,s)+"  "+o.substring(r),e.selectionStart=e.selectionEnd=s+2,this._editorContent=e.value,this._editorDirty=!0,this._cacheState()}}_onFileSelect(t){this._loadFile(t.target.value)}_toggleRestart(t){this._restartConfirmed=t.target.checked}async _restartHA(){this._restartConfirmed=!1,this._restartStatusColor="var(--status-warning)",this._restartStatus=this._t("sending_restart");try{await this.hass.callService("homeassistant","restart"),this._restartStatusColor="var(--status-success)",this._restartStatus=this._t("restart_sent")}catch(t){this._restartStatusColor="var(--status-danger)",this._restartStatus=this._t("restart_failed",t.message||t)}}render(){const t=this._cfg,e=(t,...e)=>this._t(t,...e),s=t=>ct(this._t(t));return D`
    ...
    `}_renderStep1(t,e,s){return D`
      <div class="step-card">
        <div class="step-number">1</div>
        <h2>${e("step1_title")}</h2>
        <p>${t("step1_desc")}</p>
        <ul>
          ${s.step1ListItems.map(t=>D`<li>${e(t)}</li>`)}
        </ul>
        <div class="btn-group">
          <a
    ...
    `}_renderStep3(t,e,s){return D`
      <div class="step-card">
        ...
        <div class="sub-steps">
          ${s.subSteps.map((s,r)=>D`
              <div class="sub-step">
                <span class="sub-step-number">${r+1}</span>
                <div class="sub-step-content">
                  <strong>${t(s.titleKey)}</strong>
                  ${s.descIsHtml?D`<span>${e(s.descKey)}</span>`:D`<span>${t(s.descKey)}</span>`}
                  ${s.extraKey?s.extraIsHtml?D`<p style="padding-left:8px;margin-top:4px;">
                          ${e(s.extraKey)}
                        </p>`:D`<p>${t(s.extraKey)}</p>`:""}
                </div>
              </div>
            `)}
        </div>
      ...
      <div class="editor-section">
        ...
        <div class="editor-toolbar">
          <select @change=${this._onFileSelect}>
            ...
            ${this._files.map(t=>D`<option value=${t} ?selected=${t===this._currentFile}>
                  ${t}
                </option>`)}
          </select>
    ...
    `}}const ut={domain:"woow_knx",wsType:"woow_knx/ws",configSubdir:"knx",protocolLabel:"KNX",heroIcon:"🔌",officialDocsUrl:"https://www.home-assistant.io/integrations/knx",woowAiUrl:"https://aiot.woowtech.io/blog",defaultNewFile:"knx_config.yaml",localStoragePrefix:"woow_knx",version:"2.1.0",calloutType:"warning",step1ListItems:["step1_li1","step1_li2","step1_li3","step1_li4"],subSteps:[{titleKey:"sub1_title",descKey:"sub1_desc"},{titleKey:"sub2_title",descKey:"sub2_desc",descIsHtml:!0},{titleKey:"sub3_title",descKey:"sub3_desc",descIsHtml:!0,extraKey:"sub3_list",extraIsHtml:!0},{titleKey:"sub4_title",descKey:"sub4_desc",descIsHtml:!0},{titleKey:"sub5_title",descKey:"sub5_desc",descIsHtml:!0},{titleKey:"sub6_title",descKey:"sub6_desc",descIsHtml:!0},{titleKey:"sub7_title",descKey:"sub7_desc",descIsHtml:!0}],yamlExample:'# configuration.yaml -- 僅定義裝置（連線透過 UI 設定）\nknx:\n  light:\n    - name: "客廳主燈"\n      address: "1/0/1"\n      state_address: "1/0/2"\n      brightness_address: "1/0/3"\n      brightness_state_address: "1/0/4"\n\n  switch:\n    - name: "玄關開關"\n      address: "2/0/1"\n      state_address: "2/0/2"\n\n  sensor:\n    - name: "室內溫度"\n      state_address: "3/0/1"\n      type: "temperature"'},_t={en:{hero_title:"KNX Setup Guide",hero_subtitle:"Complete KNX device YAML configuration with official docs + AI assistant",step1_title:'<span class="icon">📖</span> Read KNX Official Documentation',step1_desc:"Home Assistant provides comprehensive KNX integration documentation covering all configuration parameters. Before starting, review the official docs to understand the KNX integration architecture, including:",step1_li1:"<strong>Connection Settings</strong> -- KNX/IP Gateway or Tunneling connection methods",step1_li2:"<strong>Group Address</strong> -- Group address mapping and format",step1_li3:"<strong>Device Types</strong> -- Supported entity types (light, switch, cover, climate, sensor, etc.)",step1_li4:"<strong>YAML Examples</strong> -- Configuration examples and parameter descriptions for various devices",step1_btn:"Go to KNX Official Docs",step2_title:'<span class="icon">🤖</span> Use Woow AI Assistant for Configuration',step2_desc1:"After reading the official docs, use our AI assistant to get KNX YAML configurations tailored to your specific devices. The AI can generate precise configurations based on your device model, group addresses, and other details.",step2_desc2:"<strong>How to use:</strong> Combine the parameter requirements from the official docs with your actual device information, and ask the AI assistant to get ready-to-use YAML configurations.",step2_btn:"Go to Woow AI Assistant",step3_title:'<span class="icon">📝</span> Complete Setup Tutorial',step3_desc:"Follow these steps to complete KNX YAML configuration from scratch using official docs and AI assistant:",sub1_title:"Confirm KNX Hardware Info",sub1_desc:"Note your KNX/IP Gateway IP address, port number, and the Group Address for each device.",sub2_title:"Browse Official Documentation",sub2_desc:'Visit <a href="https://www.home-assistant.io/integrations/knx" target="_blank" rel="noopener">HA KNX Documentation</a> to understand the YAML structure and parameter meanings. Focus on the device types you need (e.g., light, switch, climate, etc.).',sub3_title:"Ask the AI Assistant",sub3_desc:'Visit <a href="https://aiot.woowtech.io/blog" target="_blank" rel="noopener">Woow AI Assistant</a> and provide the following information for configuration suggestions:',sub3_list:"‣ Device type (lights, switches, covers, thermostats, etc.)<br />‣ Group Address (e.g., 1/0/1)<br />‣ Required features (dimming, status feedback, temperature reading, etc.)",sub4_title:"Add KNX Integration via UI (Connection Setup)",sub4_desc:'Go to <em>Settings → Devices & Services → Add Integration</em>, search for "KNX" and follow the prompts to enter Gateway IP and connection method (Tunneling / Routing). This step only needs to be done once.',sub5_title:"Use the Editor Below to Write YAML Configuration",sub5_desc:"Paste the AI-generated YAML configuration into the <strong>built-in YAML editor</strong> below to directly edit <code>configuration.yaml</code> or other config files, without installing any additional packages.",sub6_title:"Restart Home Assistant",sub6_desc:"After saving, restart Home Assistant to load the new KNX configuration. Use the restart button below or go to <em>Settings → System → Restart</em>.",sub7_title:"Verify Devices and Entities",sub7_desc:"After restarting, go to <em>Settings → Devices & Services → KNX</em> to confirm devices loaded correctly. You can also check new entity states in <em>Developer Tools → States</em>.",yaml_example_label:"<strong>YAML Configuration Example (KNX Light):</strong>",callout_ui_title:"💡 Note: Connection settings via UI",callout_ui_desc:"In newer versions of Home Assistant, KNX connection settings (Tunneling / Routing) must be configured through <em>Settings → Devices & Services → Add Integration → KNX</em>.<br />YAML is only used to define devices and entities; connection parameters are no longer placed in <code>configuration.yaml</code>.",callout_done:"<strong>Done!</strong> By following the steps above, you have successfully completed the KNX device YAML configuration using official documentation and AI assistant collaboration. After the settings take effect, you can control and manage KNX devices and entities in Home Assistant.",editor_placeholder:"Select a file above to start editing, or paste AI-generated YAML configuration...",restart_desc:"After modifying <code>configuration.yaml</code>, you must restart Home Assistant for changes to take effect. New KNX devices and entities will appear after restart.",restart_tip_desc:'If you only modified automations or scripts, try using the "Reload YAML" function in <em>Settings → System → Reload</em>, which doesn\'t require a full restart. However, adding or modifying KNX devices usually requires a complete restart.',new_file_prompt:"Enter new file name (saved in config/knx/ directory):",footer:'Woow KNX Setup Guide v2.1.0 — Powered by <a href="https://aiot.woowtech.io/blog" target="_blank" rel="noopener">Woow Tech</a>'},"zh-Hant":{hero_title:"KNX 設定指南",hero_subtitle:"透過官方文檔 + AI 助手，輕鬆完成 KNX 裝置 YAML 設定",step1_title:'<span class="icon">📖</span> 閱讀 KNX 官方設定文檔',step1_desc:"Home Assistant 官方提供了完整的 KNX 整合文檔，涵蓋所有設定參數的說明。建議在開始設定前，先瀏覽官方文檔了解 KNX 整合的基本架構，包含：",step1_li1:"<strong>連線設定</strong> -- KNX/IP Gateway 或 Tunneling 的連線方式",step1_li2:"<strong>Group Address</strong> -- 群組地址的對應與格式",step1_li3:"<strong>裝置類型</strong> -- 支援的實體類型（light, switch, cover, climate, sensor 等）",step1_li4:"<strong>YAML 設定範例</strong> -- 各種裝置的設定範例與參數說明",step1_btn:"前往 KNX 官方文檔",step2_title:'<span class="icon">🤖</span> 使用 Woow AI 助手取得設定參數',step2_desc1:"閱讀官方文檔後，您可以透過我們提供的 AI 助手來取得針對您特定設備的 KNX YAML 設定。AI 助手能根據您的裝置型號、群組地址等資訊，生成精確的設定內容。",step2_desc2:"<strong>使用方式：</strong>將您從官方文檔中了解到的參數需求，搭配您的實際設備資訊，向 AI 助手詢問，即可獲得可直接使用的 YAML 設定。",step2_btn:"前往 Woow AI 助手",step3_title:'<span class="icon">📝</span> 完整設定流程教學',step3_desc:"以下是從零開始，透過官方文檔搭配 AI 助手完成 KNX YAML 設定的完整步驟：",sub1_title:"確認 KNX 硬體資訊",sub1_desc:"記下您的 KNX/IP Gateway IP 位址、埠號，以及每個裝置對應的 Group Address。",sub2_title:"瀏覽官方文檔",sub2_desc:'前往 <a href="https://www.home-assistant.io/integrations/knx" target="_blank" rel="noopener">HA KNX 文檔</a>，了解 YAML 設定的結構和各參數的意義。重點關注您需要的裝置類型（如 light、switch、climate 等）。',sub3_title:"向 AI 助手提問",sub3_desc:'前往 <a href="https://aiot.woowtech.io/blog" target="_blank" rel="noopener">Woow AI 助手</a>，提供以下資訊以獲得設定建議：',sub3_list:"‣ 裝置類型（燈具、開關、窗簾、溫控等）<br />‣ Group Address（如 1/0/1）<br />‣ 需要的功能（調光、狀態回報、溫度讀取等）",sub4_title:"透過 UI 新增 KNX 整合（連線設定）",sub4_desc:"前往 <em>設定 → 裝置與服務 → 新增整合</em>，搜尋「KNX」並依指示輸入 Gateway IP 與連線方式（Tunneling / Routing）。此步驟僅需執行一次。",sub5_title:"使用下方編輯器寫入 YAML 設定",sub5_desc:"將 AI 助手產生的 YAML 設定，透過下方的<strong>內建 YAML 編輯器</strong>直接編輯 <code>configuration.yaml</code> 或其他設定檔，無需額外安裝任何套件。",sub6_title:"重新啟動 Home Assistant",sub6_desc:"儲存設定後，需要重新啟動 Home Assistant 以載入新的 KNX 設定。請使用下方的重啟按鈕或至 <em>設定 → 系統 → 重新啟動</em>。",sub7_title:"驗證裝置與實體",sub7_desc:"重啟後，前往 <em>設定 → 裝置與服務 → KNX</em> 確認裝置已正確載入。您也可以在 <em>開發者工具 → 狀態</em> 中查看新建立的實體狀態。",yaml_example_label:"<strong>YAML 設定範例（以 KNX 燈具為例）：</strong>",callout_ui_title:"💡 注意：連線設定需透過 UI",callout_ui_desc:"在新版 Home Assistant 中，KNX 的連線設定（Tunneling / Routing）需透過 <em>設定 → 裝置與服務 → 新增整合 → KNX</em> 介面完成。<br />YAML 僅用於定義裝置與實體，連線參數不再寫在 <code>configuration.yaml</code> 中。",callout_done:"<strong>完成！</strong>透過以上步驟，您已成功透過官方文檔參考與 AI 助手協作，完成了 KNX 裝置的 YAML 設定。設定生效後，您就可以在 Home Assistant 中控制和管理 KNX 裝置與實體了。",editor_placeholder:"選擇上方檔案開始編輯，或直接貼上 AI 產出的 YAML 設定...",restart_desc:"修改 <code>configuration.yaml</code> 後，必須重新啟動 Home Assistant 才能使設定生效。新增的 KNX 裝置與實體將在重啟後出現。",restart_tip_desc:"如果只是修改了自動化或腳本，可以嘗試使用 <em>設定 → 系統 → 重新載入</em> 中的「重新載入 YAML」功能，這不需要完全重啟系統。但 KNX 裝置的新增或修改，通常需要完整重啟。",new_file_prompt:"請輸入新檔案名稱（儲存於 config/knx/ 目錄下）：",footer:'Woow KNX Setup Guide v2.1.0 — Powered by <a href="https://aiot.woowtech.io/blog" target="_blank" rel="noopener">Woow Tech</a>'}};customElements.define("woow-knx-panel",class extends ht{static get protocolConfig(){return ut}static get protocolTranslations(){return _t}});
